...
let userDetailHtml = document.querySelector(".user-details")
...
document.querySelector(".send").addEventListener("click", () => {
    let newPost = document.querySelector("textarea").value;
    if (newPost.length > 0) {
        ...
        let postHtml = `
            <div class="post-details"> 
                ...
                <div class="details">
                    <div class="user-name">${data.myProfile.details.name} ${data.myProfile.details.surname}</div>
                    <div class="post-date">${dateTime.format("DD-MM-YYYY")}</div>
                </div>
            </div> 
            <div class="post-text">
                ${newPost}
